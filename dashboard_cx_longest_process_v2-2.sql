-------------- Query Longest Process buat waybill return ----------------
...
-- AND ww.waybill_no IN ('IDE701949575431') --'IDE701766223150' --'IDE701766223150' --'IDV902145320146' --'IDE700706479068' --'IDV901710663252'
...
WHERE rr.return_confirm_time IS NOT NULL --Filter yang return aja--
),
...
last_scan_record AS (
  ...
  CASE
      WHEN rr.return_confirm_record_time IS NULL THEN "forward delivery"
      WHEN rr.return_confirm_record_time IS NOT NULL AND sr.record_time >= DATETIME(rr.return_confirm_record_time,'Asia/Jakarta') THEN "return process"
